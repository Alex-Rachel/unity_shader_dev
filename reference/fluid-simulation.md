...
- [Prerequisites](#prerequisites)
  ...
  - [Vector Calculus Basics](#vector-calculus-basics)
  - [Data Encoding Paradigm](#data-encoding-paradigm)
- [Implementation Steps in Detail](#implementation-steps-in-detail)
  - [Step 1: Data Encoding and Buffer Layout](#step-1-data-encoding-and-buffer-layout)
  - [Step 2: Discrete Differential Operators](#step-2-discrete-differential-operators)
  - [Step 3: Initial Frame and Noise](#step-3-initial-frame-and-noise)
  - [Step 4: Semi-Lagrangian Advection](#step-4-semi-lagrangian-advection)
  - [Step 5: Viscous Diffusion](#step-5-viscous-diffusion)
  - [Step 6: Pressure Projection](#step-6-pressure-projection)
  - [Step 7: External Forces and Mouse Interaction](#step-7-external-forces-and-mouse-interaction)
  - [Step 8: Boundary Conditions and Numerical Stability](#step-8-boundary-conditions-and-numerical-stability)
  - [Step 9: Visualization Rendering (Image Pass)](#step-9-visualization-rendering-image-pass)
- [Variant Details](#variant-details)
  ...
  - [Variant 3: Viscous Fingering / Reaction-Diffusion Style](#variant-3-viscous-fingering-reaction-diffusion-style)
  - [Variant 4: Gaussian Kernel SPH Particle Fluid](#variant-4-gaussian-kernel-sph-particle-fluid)
...
- [Performance Optimization Details](#performance-optimization-details)
  - [Bottleneck 1: Neighborhood Sample Count](#bottleneck-1-neighborhood-sample-count)
  - [Bottleneck 2: Multi-Pass Overhead](#bottleneck-2-multi-pass-overhead)
  - [Bottleneck 3: Advection Accuracy vs. Performance](#bottleneck-3-advection-accuracy-vs-performance)
  - [Bottleneck 4: Mipmap as Alternative to Multi-Scale Traversal](#bottleneck-4-mipmap-as-alternative-to-multi-scale-traversal)
  - [General Tips](#general-tips)
- [Combination Suggestions](#combination-suggestions)
  - [1. Fluid + Normal Map Lighting](#1-fluid-normal-map-lighting)
  - [2. Fluid + Particle Tracing](#2-fluid-particle-tracing)
  - [3. Fluid + Color Advection](#3-fluid-color-advection)
  - [4. Fluid + Audio Response](#4-fluid-audio-response)
  - [5. Fluid + 3D Volume Rendering](#5-fluid-3d-volume-rendering)
<!-- GENERATED:TOC:END -->
...
- ShaderToy-style prototype multi-buffer architecture: data flow between Buffer A/B/C/D
...
**Why**: This is the core of Helmholtz-Hodge decomposition �?decomposing the velocity field into a divergence-free part (what we want) and a curl-free part. By projecting out the divergence component via `v = v - K·∇p`, we ensure `∇·v �?0`. In ShaderToy-style prototype, the per-frame buffer feedback itself constitutes an implicit Jacobi iteration.

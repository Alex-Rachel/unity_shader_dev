...
- [Implementation Steps in Detail](#implementation-steps-in-detail)
  - [Step 1: UV Coordinate Normalization and Ray Direction Computation](#step-1-uv-coordinate-normalization-and-ray-direction-computation)
  - [Step 2: Building the Camera Matrix (Look-At)](#step-2-building-the-camera-matrix-look-at)
  - [Step 3: Defining the Scene SDF](#step-3-defining-the-scene-sdf)
  - [Step 4: Core Ray Marching Loop](#step-4-core-ray-marching-loop)
  - [Step 5: Normal Estimation](#step-5-normal-estimation)
  - [Step 6: Lighting and Shading](#step-6-lighting-and-shading)
  - [Step 7: Post-Processing (Gamma Correction and Tone Mapping)](#step-7-post-processing-gamma-correction-and-tone-mapping)
- [Common Variants in Detail](#common-variants-in-detail)
  - [1. Volumetric Ray Marching](#1-volumetric-ray-marching)
  - [2. CSG Scene Construction (Constructive Solid Geometry)](#2-csg-scene-construction-constructive-solid-geometry)
  - [3. Physically-Based Volumetric Scattering](#3-physically-based-volumetric-scattering)
  - [4. Glow Accumulation](#4-glow-accumulation)
  - [5. Refraction and Bidirectional Marching (Interior Marching)](#5-refraction-and-bidirectional-marching-interior-marching)
- [Performance Optimization in Detail](#performance-optimization-in-detail)
  - [1. Reducing SDF Call Count](#1-reducing-sdf-call-count)
  - [2. Bounding Box Acceleration](#2-bounding-box-acceleration)
  - [3. Adaptive Precision](#3-adaptive-precision)
  - [4. Early Exit](#4-early-exit)
  - [5. Reducing map() Complexity](#5-reducing-map-complexity)
  - [6. Anti-Aliasing](#6-anti-aliasing)
- [Combination Suggestions in Detail](#combination-suggestions-in-detail)
  - [1. Ray Marching + FBM Noise](#1-ray-marching-fbm-noise)
  - [2. Ray Marching + Domain Warping](#2-ray-marching-domain-warping)
  - [3. Ray Marching + PBR Materials](#3-ray-marching-pbr-materials)
  - [4. Ray Marching + Post-Processing](#4-ray-marching-post-processing)
  - [5. Ray Marching + Procedural Animation](#5-ray-marching-procedural-animation)
<!-- GENERATED:TOC:END -->

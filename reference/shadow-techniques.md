...
- [Core Principles in Detail](#core-principles-in-detail)
  - [Classic Formula (2013)](#classic-formula-2013)
  - [Improved Formula (2018)](#improved-formula-2018)
  - [Negative Extension (2020)](#negative-extension-2020)
- [Implementation Steps in Detail](#implementation-steps-in-detail)
  - [Step 1: Scene SDF Definition](#step-1-scene-sdf-definition)
  - [Step 2: Classic Soft Shadow Function](#step-2-classic-soft-shadow-function)
  - [Step 3: Improved Soft Shadow (Geometric Triangulation)](#step-3-improved-soft-shadow-geometric-triangulation)
  - [Step 4: Negative Extension Version (Smoothest Penumbra)](#step-4-negative-extension-version-smoothest-penumbra)
  - [Step 5: Bounding Volume Optimization](#step-5-bounding-volume-optimization)
  - [Step 6: Shadow Color Rendering (Color Bleeding)](#step-6-shadow-color-rendering-color-bleeding)
  - [Step 7: Integration into the Lighting Model](#step-7-integration-into-the-lighting-model)
- [Variant Details](#variant-details)
  - [Variant 1: Analytical Sphere Shadow](#variant-1-analytical-sphere-shadow)
  - [Variant 2: Terrain Heightfield Shadow](#variant-2-terrain-heightfield-shadow)
  - [Variant 3: Per-Material Hard/Soft Blend](#variant-3-per-material-hardsoft-blend)
  - [Variant 4: Multi-Layer Shadow Composition](#variant-4-multi-layer-shadow-composition)
  - [Variant 5: Volumetric Light / God Ray Reusing Shadow Function](#variant-5-volumetric-light-god-ray-reusing-shadow-function)
...
- [Combination Suggestions with Full Code](#combination-suggestions-with-full-code)
  - [With Ambient Occlusion (AO)](#with-ambient-occlusion-ao)
  - [With Subsurface Scattering (SSS)](#with-subsurface-scattering-sss)
  - [With Fog / Atmospheric Scattering](#with-fog-atmospheric-scattering)
  - [With Normal Maps / Bump Mapping](#with-normal-maps-bump-mapping)
  - [With Reflections](#with-reflections)
<!-- GENERATED:TOC:END -->
...
float calcSoftShadowImproved(vec3 ro, vec3 rd, float mint, float tmax, float w) {
    float res = 1.0;
    float t = mint;
    float ph = 1e10;  // Previous step SDF value, initialized large so first step y�?

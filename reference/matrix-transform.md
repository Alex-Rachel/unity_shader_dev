...
- [Implementation Steps](#implementation-steps)
  - [Step 1: Screen Coordinate Normalization and Aspect Ratio Correction](#step-1-screen-coordinate-normalization-and-aspect-ratio-correction)
  - [Step 2: Building Rotation Matrices](#step-2-building-rotation-matrices)
  - [Step 3: Building a LookAt Camera](#step-3-building-a-lookat-camera)
  - [Step 4: Generating Perspective Rays](#step-4-generating-perspective-rays)
  - [Step 5: Mouse-Interactive Camera](#step-5-mouse-interactive-camera)
  - [Step 6: SDF Object Domain Transforms (Translation, Rotation, Scaling)](#step-6-sdf-object-domain-transforms-translation-rotation-scaling)
  - [Step 7: Quaternion Rotation (Advanced)](#step-7-quaternion-rotation-advanced)
- [Variant Details](#variant-details)
  - [Variant 1: Orthographic Projection Camera](#variant-1-orthographic-projection-camera)
  - [Variant 2: Full Euler Angle Rotation Camera](#variant-2-full-euler-angle-rotation-camera)
  - [Variant 3: Quaternion Joint Rotation](#variant-3-quaternion-joint-rotation)
  - [Variant 4: mat4 SRT Pipeline (Full 4x4 Transform)](#variant-4-mat4-srt-pipeline-full-4x4-transform)
  - [Variant 5: Path Camera (Animated Flight)](#variant-5-path-camera-animated-flight)
- [Performance Optimization Details](#performance-optimization-details)
  - [1. Precompute Trigonometric Functions](#1-precompute-trigonometric-functions)
  - [2. Prefer mat3 Over mat4](#2-prefer-mat3-over-mat4)
  - [3. Inverse of Rotation Matrix = Transpose](#3-inverse-of-rotation-matrix-transpose)
  - [4. Avoid Rebuilding Matrices Inside the SDF](#4-avoid-rebuilding-matrices-inside-the-sdf)
  - [5. Merge Consecutive Rotations](#5-merge-consecutive-rotations)
- [Combination Suggestions](#combination-suggestions)
  - [Combining with Ray Marching / SDF (Most Common)](#combining-with-ray-marching-sdf-most-common)
  - [Combining with Noise / fBm](#combining-with-noise-fbm)
  - [Combining with Fractals / IFS](#combining-with-fractals-ifs)
  - [Combining with Lighting / Materials](#combining-with-lighting-materials)
  - [Combining with Post-Processing](#combining-with-post-processing)
<!-- GENERATED:TOC:END -->
...
- **ShaderToy-style prototype Built-in Variables**: `iResolution`, `iTime`, `iMouse`, `fragCoord`

## Core Principles

The essence of matrix transforms is **coordinate system transformation**. In ShaderToy-style prototype's ray marching pipeline, transformation matrices serve two key roles:
...
Matrix transforms are almost always used together with SDF ray marching. The camera matrix generates rays, and domain transform matrices place objects. This is the foundational pipeline for all 3D ShaderToy-style prototype shaders.

...
- [Use Cases in Detail](#use-cases-in-detail)
- [Core Principles in Detail](#core-principles-in-detail)
  - [1. Noise Functions �?Building Continuous Pseudo-Random Signals](#1-noise-functions-building-continuous-pseudo-random-signals)
  - [2. Hash Functions �?Source of Lattice Random Values](#2-hash-functions-source-of-lattice-random-values)
  - [3. FBM (Fractional Brownian Motion) �?Multi-Scale Detail Summation](#3-fbm-fractional-brownian-motion-multi-scale-detail-summation)
  - [4. Domain Warping �?Organic Distortion](#4-domain-warping-organic-distortion)
  - [5. FBM Variants �?Different Visual Characteristics](#5-fbm-variants-different-visual-characteristics)
- [Step-by-Step Implementation Details](#step-by-step-implementation-details)
  - [Step 1: Hash Function](#step-1-hash-function)
  - [Step 2: Value Noise](#step-2-value-noise)
  - [Step 3: Simplex Noise](#step-3-simplex-noise)
  - [Step 4: Standard FBM (Fractional Brownian Motion)](#step-4-standard-fbm-fractional-brownian-motion)
  - [Step 5: Ridged FBM](#step-5-ridged-fbm)
  - [Step 6: Domain Warping](#step-6-domain-warping)
  - [Step 7: Flow Noise](#step-7-flow-noise)
  - [Step 8: Derivative FBM](#step-8-derivative-fbm)
- [Common Variants in Detail](#common-variants-in-detail)
  - [Variant 1: Ridged FBM (Ridged/Turbulent FBM)](#variant-1-ridged-fbm-ridgedturbulent-fbm)
  - [Variant 2: Domain Warped FBM](#variant-2-domain-warped-fbm)
  - [Variant 3: Derivative Erosion FBM](#variant-3-derivative-erosion-fbm)
  - [Variant 4: Flow Noise](#variant-4-flow-noise)
  - [Variant 5: Custom Sea Octave FBM](#variant-5-custom-sea-octave-fbm)
- [Performance Optimization Details](#performance-optimization-details)
  - [1. Reduce Octave Count (Most Direct)](#1-reduce-octave-count-most-direct)
  - [2. Multi-Level LOD Strategy](#2-multi-level-lod-strategy)
  - [3. Use Texture Sampling Instead of Math](#3-use-texture-sampling-instead-of-math)
  - [4. Manually Unroll Loops](#4-manually-unroll-loops)
  - [5. Adaptive Step Size (Volume Rendering)](#5-adaptive-step-size-volume-rendering)
  - [6. Directional Derivative Instead of Full Gradient (Volumetric Lighting)](#6-directional-derivative-instead-of-full-gradient-volumetric-lighting)
  - [7. Early Termination](#7-early-termination)
- [Combination Suggestions in Detail](#combination-suggestions-in-detail)
  - [1. FBM + Ray Marching](#1-fbm-ray-marching)
  - [2. FBM + Finite Difference Normals + Lighting](#2-fbm-finite-difference-normals-lighting)
  - [3. FBM + Color Mapping](#3-fbm-color-mapping)
  - [4. FBM + Fresnel Water Surface Coloring](#4-fbm-fresnel-water-surface-coloring)
  - [5. Multi-Layer FBM Compositing](#5-multi-layer-fbm-compositing)
  - [6. FBM + Volumetric Lighting (Directional Derivative)](#6-fbm-volumetric-lighting-directional-derivative)
<!-- GENERATED:TOC:END -->
...
- **ShaderToy-style prototype Environment**: `iTime`, `iResolution`, `fragCoord`, `mainImage` signature

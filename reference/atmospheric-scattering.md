...
- [Core Principles](#core-principles)
  - [1. Rayleigh Scattering (Molecular Scattering)](#1-rayleigh-scattering-molecular-scattering)
  - [2. Mie Scattering (Aerosol Scattering)](#2-mie-scattering-aerosol-scattering)
  - [3. Beer-Lambert Attenuation](#3-beer-lambert-attenuation)
  - [Overall Algorithm Flow](#overall-algorithm-flow)
- [Implementation Steps](#implementation-steps)
  - [Step 1: Ray-Sphere Intersection](#step-1-ray-sphere-intersection)
  - [Step 2: Define Atmospheric Physical Constants](#step-2-define-atmospheric-physical-constants)
  - [Step 3: Implement Phase Functions](#step-3-implement-phase-functions)
  - [Step 4: Atmospheric Density Sampling](#step-4-atmospheric-density-sampling)
  - [Step 5: Light Direction Optical Depth](#step-5-light-direction-optical-depth)
  - [Step 6: Primary Scattering Integral (Core Loop)](#step-6-primary-scattering-integral-core-loop)
  - [Step 7: Tone Mapping and Output](#step-7-tone-mapping-and-output)
- [Variant Details](#variant-details)
  - [Variant 1: Non-Physical Analytical Approximation (No Ray March)](#variant-1-non-physical-analytical-approximation-no-ray-march)
  - [Variant 2: With Ozone Absorption Layer](#variant-2-with-ozone-absorption-layer)
  - [Variant 3: Subsurface Scattering (SSS)](#variant-3-subsurface-scattering-sss)
  - [Variant 4: LUT Precomputation Pipeline (Production-Grade)](#variant-4-lut-precomputation-pipeline-production-grade)
  - [Variant 5: Analytical Fast Atmosphere (No Ray March but Supports Aerial Perspective)](#variant-5-analytical-fast-atmosphere-no-ray-march-but-supports-aerial-perspective)
- [Performance Optimization Details](#performance-optimization-details)
  - [Bottleneck 1: Nested Ray March (O(N×M) Samples)](#bottleneck-1-nested-ray-march-onm-samples)
  - [Bottleneck 2: Dense exp() and pow() Calls](#bottleneck-2-dense-exp-and-pow-calls)
  - [Bottleneck 3: Full-Screen Per-Pixel Computation](#bottleneck-3-full-screen-per-pixel-computation)
  - [Bottleneck 4: High Sample Count Needed to Avoid Banding](#bottleneck-4-high-sample-count-needed-to-avoid-banding)
- [Combination Suggestions](#combination-suggestions)
  - [1. Atmospheric Scattering + Volumetric Clouds](#1-atmospheric-scattering-volumetric-clouds)
  - [2. Atmospheric Scattering + SDF Scene](#2-atmospheric-scattering-sdf-scene)
  - [3. Atmospheric Scattering + God Rays](#3-atmospheric-scattering-god-rays)
  - [4. Atmospheric Scattering + Terrain Rendering](#4-atmospheric-scattering-terrain-rendering)
  - [5. SSS + PBR Materials](#5-sss-pbr-materials)
<!-- GENERATED:TOC:END -->

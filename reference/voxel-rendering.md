...
- [Prerequisites](#prerequisites)
  ...
  - [Ray-AABB Intersection (Ray-Box Intersection)](#ray-aabb-intersection-ray-box-intersection)
  - [Basic Lighting Models](#basic-lighting-models)
  - [SDF (Signed Distance Field) Basics](#sdf-signed-distance-field-basics)
- [Implementation Steps](#implementation-steps)
  ...
  - [Step 7: Neighbor Voxel Ambient Occlusion (AO)](#step-7-neighbor-voxel-ambient-occlusion-ao)
...
- [Variant Details](#variant-details)
  ...
  - [Variant 5: PBR Lighting + Multi-Bounce Reflections](#variant-5-pbr-lighting-multi-bounce-reflections)
- [In-Depth Performance Optimization](#in-depth-performance-optimization)
  - [Main Bottlenecks](#main-bottlenecks)
  - [Optimization Techniques](#optimization-techniques)
- [Complete Combination Code Examples](#complete-combination-code-examples)
  - [Procedural Noise Terrain](#procedural-noise-terrain)
  - [Texture Mapping](#texture-mapping)
  - [Atmospheric Scattering / Volumetric Fog](#atmospheric-scattering-volumetric-fog)
  - [Water Surface Rendering (Voxel Water Scene)](#water-surface-rendering-voxel-water-scene)
  - [Global Illumination (Monte Carlo Hemisphere Sampling)](#global-illumination-monte-carlo-hemisphere-sampling)
<!-- GENERATED:TOC:END -->
...
**Difference from the base version**: Builds a multi-level mipmap hierarchy of voxels (e.g., 64�?2�?6�?�?�?), casts cone-shaped rays from hit points, samples coarser LOD levels as distance increases, achieving diffuse/specular global illumination.

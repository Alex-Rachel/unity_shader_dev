...
- [Implementation Steps](#implementation-steps)
  - [Step 1: Camera and Ray Construction](#step-1-camera-and-ray-construction)
  - [Step 2: Volume Boundary Intersection](#step-2-volume-boundary-intersection)
  - [Step 3: Density Field Definition](#step-3-density-field-definition)
  - [Step 4: Ray Marching Main Loop](#step-4-ray-marching-main-loop)
  - [Step 5: Lighting Calculation](#step-5-lighting-calculation)
  - [Step 6: Color Mapping](#step-6-color-mapping)
  - [Step 7: Final Compositing and Post-Processing](#step-7-final-compositing-and-post-processing)
- [Variant Details](#variant-details)
  - [Variant 1: Emissive Volume (Flames/Explosions)](#variant-1-emissive-volume-flamesexplosions)
  - [Variant 2: Physical Scattering Atmosphere (Rayleigh + Mie)](#variant-2-physical-scattering-atmosphere-rayleigh-mie)
  - [Variant 3: Frostbite Energy-Conserving Integration](#variant-3-frostbite-energy-conserving-integration)
  - [Variant 4: Production-Grade Clouds (Horizon Zero Dawn Style)](#variant-4-production-grade-clouds-horizon-zero-dawn-style)
  - [Variant 5: Gradient Normal Surface Lighting (Fur Ball / Volume Surface)](#variant-5-gradient-normal-surface-lighting-fur-ball-volume-surface)
- [In-Depth Performance Optimization](#in-depth-performance-optimization)
  - [1. Early Ray Termination](#1-early-ray-termination)
  - [2. LOD Noise](#2-lod-noise)
  - [3. Adaptive Step Size](#3-adaptive-step-size)
  - [4. Dithering](#4-dithering)
  - [5. Bounding Volume Clipping](#5-bounding-volume-clipping)
  - [6. Density Threshold Skip](#6-density-threshold-skip)
  - [7. Minimal Shadow Step Count](#7-minimal-shadow-step-count)
  - [8. Temporal Reprojection](#8-temporal-reprojection)
- [Combination Suggestions](#combination-suggestions)
  - [1. SDF Terrain + Volumetric Clouds](#1-sdf-terrain-volumetric-clouds)
  - [2. Volumetric Fog + Scene Lighting](#2-volumetric-fog-scene-lighting)
  - [3. Multi-Layer Volumes](#3-multi-layer-volumes)
  - [4. Particle System + Volume](#4-particle-system-volume)
  - [5. Post-Process Light Shafts (God Rays)](#5-post-process-light-shafts-god-rays)
  - [6. Procedural Sky + Volumetric Clouds](#6-procedural-sky-volumetric-clouds)
<!-- GENERATED:TOC:END -->
...
**Practical application**: Clouds typically use a dual-lobe HG function, mixing a forward scattering lobe (g�?.8) and a backward scattering lobe (g�?0.2) to simulate the real light scattering characteristics of cloud layers. Forward scattering produces the silver lining, while backward scattering provides volume definition.

...
- [Implementation Steps in Detail](#implementation-steps-in-detail)
  - [Step 1: Hard Boolean Operations](#step-1-hard-boolean-operations)
  - [Step 2: Smooth Union �?Polynomial Version](#step-2-smooth-union-polynomial-version)
  - [Step 3: Smooth Subtraction and Smooth Intersection �?Polynomial Version](#step-3-smooth-subtraction-and-smooth-intersection-polynomial-version)
  - [Step 4: Quadratic Optimized Smooth Operations](#step-4-quadratic-optimized-smooth-operations)
  - [Step 5: Basic SDF Primitives](#step-5-basic-sdf-primitives)
  - [Step 6: CSG Combination for Scene Construction](#step-6-csg-combination-for-scene-construction)
  - [Step 7: Organic Body Modeling with Smooth CSG](#step-7-organic-body-modeling-with-smooth-csg)
  - [Step 8: Ray Marching Main Loop](#step-8-ray-marching-main-loop)
  - [Step 9: Normal Computation and Lighting](#step-9-normal-computation-and-lighting)
- [Common Variants in Detail](#common-variants-in-detail)
  - [Variant 1: Polynomial Smooth Union (Most Universal Version)](#variant-1-polynomial-smooth-union-most-universal-version)
  - [Variant 2: Exponential Smooth Union](#variant-2-exponential-smooth-union)
  - [Variant 3: Smooth Operations with Color Blending](#variant-3-smooth-operations-with-color-blending)
  - [Variant 4: Layered CSG Modeling (Architectural / Industrial Scenes)](#variant-4-layered-csg-modeling-architectural-industrial-scenes)
  - [Variant 5: Large-Scale Organic Character Modeling](#variant-5-large-scale-organic-character-modeling)
- [Performance Optimization in Detail](#performance-optimization-in-detail)
  ...
  - [2. Reducing SDF Sample Count](#2-reducing-sdf-sample-count)
  - [3. smin/smax Selection](#3-sminsmax-selection)
  - [4. Avoiding k=0 with smin](#4-avoiding-k0-with-smin)
  - [5. Symmetry Exploitation](#5-symmetry-exploitation)
- [Combination Suggestions in Detail](#combination-suggestions-in-detail)
  - [1. CSG + Domain Repetition](#1-csg-domain-repetition)
  - [2. CSG + Procedural Displacement](#2-csg-procedural-displacement)
  - [3. CSG + Procedural Texturing](#3-csg-procedural-texturing)
  - [4. CSG + 2D SDF](#4-csg-2d-sdf)
  - [5. CSG + Animation](#5-csg-animation)
<!-- GENERATED:TOC:END -->

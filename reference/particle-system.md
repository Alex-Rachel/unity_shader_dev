...
- [Implementation Steps in Detail](#implementation-steps-in-detail)
  ...
  - [Step 5: Particle Rendering �?Point Light / Metaball Style](#step-5-particle-rendering-point-light-metaball-style)
  - [Step 6: Frame Feedback Motion Blur](#step-6-frame-feedback-motion-blur)
  - [Step 7: HSV Coloring and Star Glare Effects](#step-7-hsv-coloring-and-star-glare-effects)
- [Common Variant Details](#common-variant-details)
  ...
  - [Variant 6: Vortex/Storm Particle System](#variant-6-vortexstorm-particle-system)
  - [Variant 7: Meteor/Trailing Line Rendering](#variant-7-meteortrailing-line-rendering)
  - [Variant 8: Fountain/Upward Jet Particle System](#variant-8-fountainupward-jet-particle-system)
  - [Variant 10: Spiral Array/Magic Particle System](#variant-10-spiral-arraymagic-particle-system)
- [Brightness Budget Quick Reference](#brightness-budget-quick-reference)
- [Performance Optimization In-Depth Analysis](#performance-optimization-in-depth-analysis)
  - [1. Particle Count and Loop Overhead](#1-particle-count-and-loop-overhead)
  - [2. Frame Feedback as Substitute for High Particle Count](#2-frame-feedback-as-substitute-for-high-particle-count)
  - [3. N-body Interaction Complexity](#3-n-body-interaction-complexity)
  - [4. Sub-frame Stepping](#4-sub-frame-stepping)
  - [5. Precision and Numerical Stability](#5-precision-and-numerical-stability)
- [Combination Suggestions with Complete Code](#combination-suggestions-with-complete-code)
  - [Combining with Raymarching Scenes](#combining-with-raymarching-scenes)
  - [Combining with Noise / Flow Fields](#combining-with-noise-flow-fields)
  - [Combining with Post-Processing](#combining-with-post-processing)
  - [Combining with SDF Shape Rendering](#combining-with-sdf-shape-rendering)
  - [Combining with Voronoi Spatial Acceleration Structure](#combining-with-voronoi-spatial-acceleration-structure)
<!-- GENERATED:TOC:END -->
...
> **NOTE:** Code examples in this document primarily target the ShaderToy-style prototype environment. **For Unity URP integration, refer to the Unity URP single-file template in SKILL.md**, which includes complete HTML + JS + GLSL code.
...
- ShaderToy-style prototype architecture (`mainImage`, `iTime`, `iResolution`, `iChannel`, multi-Buffer passes)
...
**Why**: When inter-frame persistent state is needed (physics collisions, force field interactions, N-body simulations), particle data must be written to a Buffer and read back the next frame. In ShaderToy-style prototype, each pixel is a storage cell.

...
- [Step-by-Step Tutorial](#step-by-step-tutorial)
  - [Step 1: Cosine Palette Function](#step-1-cosine-palette-function)
  - [Step 2: Classic Parameter Presets](#step-2-classic-parameter-presets)
  - [Step 3: HSV to RGB Conversion (Standard + Smooth)](#step-3-hsv-to-rgb-conversion-standard-smooth)
  - [Step 4: HSL to RGB Conversion](#step-4-hsl-to-rgb-conversion)
  - [Step 5: Bidirectional RGB <-> HSV Conversion](#step-5-bidirectional-rgb-hsv-conversion)
  - [Step 6: CIE Lab/Lch Perceptually Uniform Interpolation](#step-6-cie-lablch-perceptually-uniform-interpolation)
  - [Step 7: sRGB Gamma and Linear Space Workflow](#step-7-srgb-gamma-and-linear-space-workflow)
  - [Step 8: Blackbody Radiation Palette](#step-8-blackbody-radiation-palette)
- [Variant Detailed Descriptions](#variant-detailed-descriptions)
  - [Variant 1: Multi-Harmonic Cosine Palette (Anti-Aliased)](#variant-1-multi-harmonic-cosine-palette-anti-aliased)
  - [Variant 2: Hash-Driven Per-Tile Color Variation](#variant-2-hash-driven-per-tile-color-variation)
  - [Variant 3: Saturation-Preserving Improved RGB Interpolation](#variant-3-saturation-preserving-improved-rgb-interpolation)
  - [Variant 4: Circular Hue Interpolation (HSV/Lch Space)](#variant-4-circular-hue-interpolation-hsvlch-space)
  - [Variant 5: Additive Color Stacking (Glow/HDR Effects)](#variant-5-additive-color-stacking-glowhdr-effects)
- [Performance Optimization Details](#performance-optimization-details)
  - [1. Branchless HSV/HSL Conversion](#1-branchless-hsvhsl-conversion)
  - [2. Band-Limited Filtering for Multi-Harmonic Palettes](#2-band-limited-filtering-for-multi-harmonic-palettes)
  - [3. Lch Pipeline Cost Analysis](#3-lch-pipeline-cost-analysis)
  - [4. sRGB Gamma Approximation](#4-srgb-gamma-approximation)
  - [5. Cosine Palette Vectorization](#5-cosine-palette-vectorization)
  - [6. Texture sRGB Decoding](#6-texture-srgb-decoding)
- [Combination Suggestions in Detail](#combination-suggestions-in-detail)
  - [1. Cosine Palette + SDF Raymarching](#1-cosine-palette-sdf-raymarching)
  - [2. HSL/HSV + Data Visualization](#2-hslhsv-data-visualization)
  - [3. Cosine Palette + Fractals/Noise](#3-cosine-palette-fractalsnoise)
  - [4. Blackbody Palette + Volume Rendering/Fire](#4-blackbody-palette-volume-renderingfire)
  - [5. Linear Space Workflow + Any Palette Technique](#5-linear-space-workflow-any-palette-technique)
  - [6. Hash + Palette + Tiling System](#6-hash-palette-tiling-system)
<!-- GENERATED:TOC:END -->
...
**Why**: Only 4 vec3 parameters are needed to generate infinite smooth color ramps, with extremely low computational cost (a single cos operation). This function is widely used in the ShaderToy-style prototype community and is the cornerstone of procedural coloring.

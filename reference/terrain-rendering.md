...
- [Implementation Steps](#implementation-steps)
  - [Step 1: Noise and Hash Functions](#step-1-noise-and-hash-functions)
  - [Step 2: Noise with Analytical Derivatives (Advanced)](#step-2-noise-with-analytical-derivatives-advanced)
  - [Step 3: FBM Terrain Heightfield (with Derivative Erosion)](#step-3-fbm-terrain-heightfield-with-derivative-erosion)
  - [Step 4: LOD Multi-Resolution Terrain Functions](#step-4-lod-multi-resolution-terrain-functions)
  - [Step 5: Adaptive Step Size Ray Marching](#step-5-adaptive-step-size-ray-marching)
  - [Step 6: Binary Refinement (Optional)](#step-6-binary-refinement-optional)
  - [Step 7: Normal Calculation](#step-7-normal-calculation)
  - [Step 8: Material and Color Assignment](#step-8-material-and-color-assignment)
  - [Step 9: Lighting Model](#step-9-lighting-model)
  - [Step 10: Soft Shadows](#step-10-soft-shadows)
  - [Step 11: Aerial Perspective and Fog](#step-11-aerial-perspective-and-fog)
  - [Step 12: Sky Rendering](#step-12-sky-rendering)
  - [Step 13: Camera Setup](#step-13-camera-setup)
- [Common Variants](#common-variants)
  - [Variant 1: Relaxation Marching](#variant-1-relaxation-marching)
  - [Variant 2: Sign-Alternating FBM](#variant-2-sign-alternating-fbm)
  - [Variant 3: Texture-Driven Heightfield + 3D Displacement](#variant-3-texture-driven-heightfield-3d-displacement)
  - [Variant 4: Directional Erosion Noise](#variant-4-directional-erosion-noise)
  - [Variant 5: Volumetric Clouds + God Rays](#variant-5-volumetric-clouds-god-rays)
- [In-Depth Performance Optimization](#in-depth-performance-optimization)
  - [1. LOD Layering (Most Important Optimization)](#1-lod-layering-most-important-optimization)
  - [2. Upper Bound Clipping (Bounding Plane)](#2-upper-bound-clipping-bounding-plane)
  - [3. Adaptive Precision Threshold](#3-adaptive-precision-threshold)
  - [4. Texture Instead of Procedural Noise](#4-texture-instead-of-procedural-noise)
  - [5. Early Exit](#5-early-exit)
  - [6. Jittered Start](#6-jittered-start)
- [Complete Combination Code Examples](#complete-combination-code-examples)
  - [1. Terrain + Water Surface](#1-terrain-water-surface)
  - [2. Terrain + Volumetric Clouds](#2-terrain-volumetric-clouds)
  - [3. Terrain + Volumetric Fog/Dust](#3-terrain-volumetric-fogdust)
  - [4. Terrain + SDF Object Placement](#4-terrain-sdf-object-placement)
  - [5. Terrain + Temporal Anti-Aliasing (TAA)](#5-terrain-temporal-anti-aliasing-taa)
<!-- GENERATED:TOC:END -->
...
float noise3D(in vec3 x) {
    ...
    vec3 f = fract(x);
    f = f * f * (3.0 - 2.0 * f);
    // 3D�?D flattening: offset UV by p.z, sample two texture layers and interpolate

...
- [Implementation Steps �?Detailed Explanation](#implementation-steps-detailed-explanation)
  - [Step 1: Hash Function �?Generating Pseudo-Random Feature Points](#step-1-hash-function-generating-pseudo-random-feature-points)
  - [Step 2: Grid Partitioning and Neighborhood Search �?F1 Distance](#step-2-grid-partitioning-and-neighborhood-search-f1-distance)
  - [Step 3: F1 + F2 Tracking �?Edge Detection](#step-3-f1-f2-tracking-edge-detection)
  - [Step 4: Exact Border Distance �?Two-Pass Algorithm](#step-4-exact-border-distance-two-pass-algorithm)
  - [Step 5: Feature Point Animation](#step-5-feature-point-animation)
  - [Step 6: Coloring and Visualization](#step-6-coloring-and-visualization)
- [Variant Detailed Descriptions](#variant-detailed-descriptions)
  - [Variant 1: 3D Voronoi + fBm Fire](#variant-1-3d-voronoi-fbm-fire)
  - [Variant 2: Rounded Borders (3rd-Order Voronoi)](#variant-2-rounded-borders-3rd-order-voronoi)
  - [Variant 3: Voronoise (Unified Noise-Voronoi Framework)](#variant-3-voronoise-unified-noise-voronoi-framework)
  - [Variant 4: Crack Textures (Multi-Layer Recursive Voronoi)](#variant-4-crack-textures-multi-layer-recursive-voronoi)
  - [Variant 5: Tileable 3D Worley (Cloud Noise)](#variant-5-tileable-3d-worley-cloud-noise)
- [Performance Optimization Details](#performance-optimization-details)
  - [1. Avoid sqrt in Distance Comparisons](#1-avoid-sqrt-in-distance-comparisons)
  - [2. Unroll 3D Voronoi Loops](#2-unroll-3d-voronoi-loops)
  - [3. Minimize Search Range](#3-minimize-search-range)
  - [4. Hash Function Selection](#4-hash-function-selection)
  - [5. Layer Count Control for Multi-Layer fBm](#5-layer-count-control-for-multi-layer-fbm)
- [Combination Suggestions in Detail](#combination-suggestions-in-detail)
  - [1. Voronoi + fBm Perturbation](#1-voronoi-fbm-perturbation)
  - [2. Voronoi + Bump Mapping](#2-voronoi-bump-mapping)
  - [3. Voronoi + Palette Mapping](#3-voronoi-palette-mapping)
  - [4. Voronoi + Raymarching](#4-voronoi-raymarching)
  - [5. Multi-Scale Voronoi Stacking](#5-multi-scale-voronoi-stacking)
<!-- GENERATED:TOC:END -->

...
- [Core Principles in Detail](#core-principles-in-detail)
- [Implementation Steps in Detail](#implementation-steps-in-detail)
  - [Step 1: Coordinate Normalization and Aspect Ratio Correction](#step-1-coordinate-normalization-and-aspect-ratio-correction)
  - [Step 2: Defining SDF Primitive Functions](#step-2-defining-sdf-primitive-functions)
  - [Step 3: CSG Boolean Operations](#step-3-csg-boolean-operations)
  - [Step 4: Coordinate Transforms](#step-4-coordinate-transforms)
  - [Step 5: Distance Field Visualization and Rendering](#step-5-distance-field-visualization-and-rendering)
  - [Step 6: Stroke and Border Rendering](#step-6-stroke-and-border-rendering)
  - [Step 7: Multi-Layer Compositing](#step-7-multi-layer-compositing)
- [Variant Detailed Descriptions](#variant-detailed-descriptions)
  - [Variant 1: Solid Fill + Stroke Mode](#variant-1-solid-fill-stroke-mode)
  - [Variant 2: Multi-Layer CSG Illustration](#variant-2-multi-layer-csg-illustration)
  - [Variant 3: Hexagonal Grid Tiling](#variant-3-hexagonal-grid-tiling)
  - [Variant 4: Organic Shapes (Polar Coordinate SDF)](#variant-4-organic-shapes-polar-coordinate-sdf)
  - [Variant 5: Bezier Curve SDF](#variant-5-bezier-curve-sdf)
- [Performance Optimization in Detail](#performance-optimization-in-detail)
  - [1. Reducing sqrt Calls](#1-reducing-sqrt-calls)
  - [2. fwidth vs Fixed Pixel Width](#2-fwidth-vs-fixed-pixel-width)
  - [3. Avoiding Excessive Boolean Operation Nesting](#3-avoiding-excessive-boolean-operation-nesting)
  - [4. Supersampling AA Trade-off](#4-supersampling-aa-trade-off)
  - [5. Step Size Optimization for 2D Soft Shadows](#5-step-size-optimization-for-2d-soft-shadows)
- [Combination Suggestions in Detail](#combination-suggestions-in-detail)
  - [1. SDF + Noise Textures](#1-sdf-noise-textures)
  - [2. SDF + 2D Lighting and Shadows](#2-sdf-2d-lighting-and-shadows)
  - [3. SDF + Normal Mapping / Bump Mapping](#3-sdf-normal-mapping-bump-mapping)
  - [4. SDF + Domain Repetition (Spatial Tiling)](#4-sdf-domain-repetition-spatial-tiling)
  - [5. SDF + Animation](#5-sdf-animation)
- [Extended 2D SDF Primitives Reference](#extended-2d-sdf-primitives-reference)
  - [sdRoundedBox �?Rounded Box with Independent Corner Radii](#sdroundedbox-rounded-box-with-independent-corner-radii)
  - [sdOrientedBox �?Oriented Box](#sdorientedbox-oriented-box)
  - [sdArc �?Arc](#sdarc-arc)
  - [sdPie �?Pie / Sector](#sdpie-pie-sector)
  - [sdRing �?Ring](#sdring-ring)
  - [sdMoon �?Moon Shape](#sdmoon-moon-shape)
  - [sdHeart �?Heart (Approximate)](#sdheart-heart-approximate)
  - [sdVesica �?Vesica / Lens Shape](#sdvesica-vesica-lens-shape)
  - [sdEgg �?Egg Shape](#sdegg-egg-shape)
  - [sdEquilateralTriangle �?Equilateral Triangle](#sdequilateraltriangle-equilateral-triangle)
  - [sdPentagon �?Pentagon](#sdpentagon-pentagon)
  - [sdHexagon �?Hexagon](#sdhexagon-hexagon)
  - [sdOctagon �?Octagon](#sdoctagon-octagon)
  - [sdStar �?N-Pointed Star](#sdstar-n-pointed-star)
  - [sdBezier (Extended) �?Quadratic Bezier Curve SDF](#sdbezier-extended-quadratic-bezier-curve-sdf)
  - [sdParabola �?Parabola](#sdparabola-parabola)
  - [sdCross �?Cross Shape](#sdcross-cross-shape)
- [2D SDF Modifiers Reference](#2d-sdf-modifiers-reference)
  - [opRound2D �?Rounding Modifier](#opround2d-rounding-modifier)
  - [opAnnular2D �?Annular (Hollowing) Modifier](#opannular2d-annular-hollowing-modifier)
  - [opRepeat2D �?Grid Repetition](#oprepeat2d-grid-repetition)
  - [opMirror2D �?Arbitrary Mirror](#opmirror2d-arbitrary-mirror)
<!-- GENERATED:TOC:END -->

...
- [Step-by-Step Details](#step-by-step-details)
  - [Step 1: Basic Cartesian Domain Repetition (mod Repetition)](#step-1-basic-cartesian-domain-repetition-mod-repetition)
  - [Step 2: Symmetric Fold Repetition (abs-mod Hybrid)](#step-2-symmetric-fold-repetition-abs-mod-hybrid)
  - [Step 3: Angular Domain Repetition (Polar Coordinate Folding)](#step-3-angular-domain-repetition-polar-coordinate-folding)
  - [Step 4: fract Domain Folding (For Fractal Iteration)](#step-4-fract-domain-folding-for-fractal-iteration)
  - [Step 5: Iterative abs Folding (IFS / Kali-set)](#step-5-iterative-abs-folding-ifs-kali-set)
  - [Step 6: Reflection Folding (Polyhedral Symmetry)](#step-6-reflection-folding-polyhedral-symmetry)
  - [Step 7: Toroidal / Cylindrical Domain Warping (displaceLoop)](#step-7-toroidal-cylindrical-domain-warping-displaceloop)
  - [Step 8: 1D Centered Domain Repetition (with Cell ID)](#step-8-1d-centered-domain-repetition-with-cell-id)
- [Common Variants in Detail](#common-variants-in-detail)
  - [1. Volumetric Glow Rendering](#1-volumetric-glow-rendering)
  - [2. Single-Axis / Dual-Axis Selective Repetition](#2-single-axis-dual-axis-selective-repetition)
  - [3. Fractal fract Domain Folding (Apollonian Type)](#3-fractal-fract-domain-folding-apollonian-type)
  - [4. Multi-Level Nested Repetition](#4-multi-level-nested-repetition)
  - [5. Bounded Domain Repetition (Finite Repetition)](#5-bounded-domain-repetition-finite-repetition)
- [Performance Optimization Deep Dive](#performance-optimization-deep-dive)
  - [Bottleneck 1: High Iteration Count in Fractal Loops](#bottleneck-1-high-iteration-count-in-fractal-loops)
  - [Bottleneck 2: mod Repetition Causing Inaccurate Distance Fields](#bottleneck-2-mod-repetition-causing-inaccurate-distance-fields)
  - [Bottleneck 3: Compilation Time from Nested Repetition](#bottleneck-3-compilation-time-from-nested-repetition)
  - [Bottleneck 4: Sampling Rate for Volumetric Glow Rendering](#bottleneck-4-sampling-rate-for-volumetric-glow-rendering)
- [Combination Suggestions with Complete Code](#combination-suggestions-with-complete-code)
  - [1. Domain Repetition + Ray Marching](#1-domain-repetition-ray-marching)
  - [2. Domain Repetition + Orbit Trap Coloring](#2-domain-repetition-orbit-trap-coloring)
  - [3. Domain Repetition + Toroidal / Polar Coordinate Warping](#3-domain-repetition-toroidal-polar-coordinate-warping)
  - [4. Domain Repetition + Noise / Random Variants](#4-domain-repetition-noise-random-variants)
  - [5. Domain Repetition + Polar Coordinate Spiral Transform](#5-domain-repetition-polar-coordinate-spiral-transform)
<!-- GENERATED:TOC:END -->

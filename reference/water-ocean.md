...
- [Core Principles](#core-principles)
  - [1. Wave Generation: Exponential Sine Layering + Derivative Domain Warping](#1-wave-generation-exponential-sine-layering-derivative-domain-warping)
  - [2. Lighting Model: Schlick Fresnel + Subsurface Scattering Approximation](#2-lighting-model-schlick-fresnel-subsurface-scattering-approximation)
  - [3. Water Surface Intersection: Bounded Heightfield Marching](#3-water-surface-intersection-bounded-heightfield-marching)
- [Implementation Steps](#implementation-steps)
  - [Step 1: Exponential Sine Wave Function](#step-1-exponential-sine-wave-function)
  - [Step 2: Multi-Octave Wave Layering with Domain Warping](#step-2-multi-octave-wave-layering-with-domain-warping)
  - [Step 3: Bounded Bounding Box Ray Marching](#step-3-bounded-bounding-box-ray-marching)
  - [Step 4: Normal Calculation with Distance Smoothing](#step-4-normal-calculation-with-distance-smoothing)
...
- [Common Variants](#common-variants)
  ...
  - [Variant 2: FBM Bump-Mapped Lake Surface (Plane Intersection + Bump Mapping)](#variant-2-fbm-bump-mapped-lake-surface-plane-intersection-bump-mapping)
  - [Variant 3: Ridged Noise Coastal Waves](#variant-3-ridged-noise-coastal-waves)
  - [Variant 4: Flow Map Water Animation (Rivers/Streams)](#variant-4-flow-map-water-animation-riversstreams)
  - [Variant 5: Beer's Law Water Absorption + Volumetric Scattering](#variant-5-beers-law-water-absorption-volumetric-scattering)
- [In-Depth Performance Optimization](#in-depth-performance-optimization)
  - [1. Dual Iteration Count Strategy (Most Critical Optimization)](#1-dual-iteration-count-strategy-most-critical-optimization)
  - [2. Distance-Adaptive Normal Smoothing](#2-distance-adaptive-normal-smoothing)
  - [3. Bounding Box Clipping](#3-bounding-box-clipping)
  - [4. Adaptive Step Size](#4-adaptive-step-size)
  - [5. Filter Width-Aware Normal Attenuation (Advanced)](#5-filter-width-aware-normal-attenuation-advanced)
  - [6. LOD Conditional Detail](#6-lod-conditional-detail)
- [Combination Suggestions](#combination-suggestions)
  - [1. Combining with Volumetric Clouds](#1-combining-with-volumetric-clouds)
  - [2. Combining with Terrain Systems](#2-combining-with-terrain-systems)
  - [3. Combining with Caustics](#3-combining-with-caustics)
  - [4. Combining with Fog/Atmospheric Scattering](#4-combining-with-fogatmospheric-scattering)
  - [5. Combining with Post-Processing](#5-combining-with-post-processing)
<!-- GENERATED:TOC:END -->

...
- [Implementation Steps](#implementation-steps)
  - [Step 1: Basic Texture Sampling and UV Normalization](#step-1-basic-texture-sampling-and-uv-normalization)
  - [Step 2: Using textureLod to Control Mipmap Level](#step-2-using-texturelod-to-control-mipmap-level)
  - [Step 3: Using texelFetch for Exact Pixel Data Access](#step-3-using-texelfetch-for-exact-pixel-data-access)
  - [Step 4: Manual Bilinear Interpolation + Quintic Hermite Smoothing](#step-4-manual-bilinear-interpolation-quintic-hermite-smoothing)
  - [Step 5: FBM (Fractional Brownian Motion) Noise from Textures](#step-5-fbm-fractional-brownian-motion-noise-from-textures)
  - [Step 6: Separable Gaussian Blur (Multi-Pass Convolution)](#step-6-separable-gaussian-blur-multi-pass-convolution)
  - [Step 7: Dispersion Sampling (Wavelength-Dependent Displacement)](#step-7-dispersion-sampling-wavelength-dependent-displacement)
  - [Step 8: IBL Environment Sampling (textureLod + Roughness Mapping)](#step-8-ibl-environment-sampling-texturelod-roughness-mapping)
- [Variant Details](#variant-details)
  - [Variant 1: Anisotropic Flow Field Blur](#variant-1-anisotropic-flow-field-blur)
  - [Variant 2: Texture as Data Storage (Buffer-as-Data)](#variant-2-texture-as-data-storage-buffer-as-data)
  - [Variant 3: Chromatic Dispersion](#variant-3-chromatic-dispersion)
  - [Variant 4: Triplanar Texture Mapping](#variant-4-triplanar-texture-mapping)
  - [Variant 5: Temporal Reprojection (TAA)](#variant-5-temporal-reprojection-taa)
- [Performance Optimization Details](#performance-optimization-details)
  - [Bottleneck 1: Texture Sampling Bandwidth](#bottleneck-1-texture-sampling-bandwidth)
  - [Bottleneck 2: Separable Blur](#bottleneck-2-separable-blur)
  - [Bottleneck 3: Mip Selection in Ray Marching](#bottleneck-3-mip-selection-in-ray-marching)
  - [Bottleneck 4: Manual Interpolation for High-Frequency Noise](#bottleneck-4-manual-interpolation-for-high-frequency-noise)
  - [Bottleneck 5: Multi-Buffer Feedback Latency](#bottleneck-5-multi-buffer-feedback-latency)
- [Complete Combination Code Examples](#complete-combination-code-examples)
  - [Combining with SDF Ray Marching](#combining-with-sdf-ray-marching)
  - [Combining with Procedural Noise (Domain Warping)](#combining-with-procedural-noise-domain-warping)
  - [Combining with Post-Processing Pipeline](#combining-with-post-processing-pipeline)
  - [Combining with PBR/IBL Lighting](#combining-with-pbribl-lighting)
  - [Combining with Simulation/Feedback Systems](#combining-with-simulationfeedback-systems)
<!-- GENERATED:TOC:END -->
...
- **ShaderToy-style prototype Multi-Pass Architecture**: Image pass is the final output, Buffer A/B/C/D are intermediate computation passes, bound to textures or buffers via `iChannel0~3`
...
**Why**: `texture()` accepts UV coordinates in the `[0,1]` range. ShaderToy-style prototype provides pixel coordinates `fragCoord`, which need to be normalized by dividing by the resolution.
...
// Read keyboard input (ShaderToy-style prototype keyboard texture)

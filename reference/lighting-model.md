...
- [Prerequisites](#prerequisites)
  - [Vector Math Fundamentals](#vector-math-fundamentals)
  - [GLSL Fundamentals](#glsl-fundamentals)
  - [Basic Computer Graphics Concepts](#basic-computer-graphics-concepts)
  - [Raymarching Basics (Recommended)](#raymarching-basics-recommended)
- [Implementation Steps in Detail](#implementation-steps-in-detail)
  - [Step 1: Scene Foundation (UV, Camera, Raymarching)](#step-1-scene-foundation-uv-camera-raymarching)
  - [Step 2: Lambert Diffuse](#step-2-lambert-diffuse)
  - [Step 3: Blinn-Phong Specular](#step-3-blinn-phong-specular)
  - [Step 4: Fresnel-Schlick Approximation](#step-4-fresnel-schlick-approximation)
  - [Step 5: GGX Normal Distribution Function (D Term)](#step-5-ggx-normal-distribution-function-d-term)
  - [Step 6: Geometric Occlusion Function (G Term)](#step-6-geometric-occlusion-function-g-term)
  - [Step 7: Assembling the Cook-Torrance BRDF](#step-7-assembling-the-cook-torrance-brdf)
  - [Step 8: Multi-Light Accumulation and Final Compositing](#step-8-multi-light-accumulation-and-final-compositing)
  - [Step 9: Ambient Occlusion (AO)](#step-9-ambient-occlusion-ao)
- [Variant Details](#variant-details)
  - [Variant 1: Classic Phong (Non-PBR)](#variant-1-classic-phong-non-pbr)
  - [Variant 2: Point Light Attenuation](#variant-2-point-light-attenuation)
  - [Variant 3: IBL (Image-Based Lighting)](#variant-3-ibl-image-based-lighting)
  - [Variant 4: Subsurface Scattering Approximation (SSS)](#variant-4-subsurface-scattering-approximation-sss)
  - [Variant 5: Beer's Law Water Lighting](#variant-5-beers-law-water-lighting)
- [Performance Optimization In-Depth Analysis](#performance-optimization-in-depth-analysis)
  - [1. Avoiding the Cost of pow(x, 5.0)](#1-avoiding-the-cost-of-powx-50)
  - [2. Merging G and the Denominator (Visibility Term)](#2-merging-g-and-the-denominator-visibility-term)
  - [3. AO Sample Count](#3-ao-sample-count)
  - [4. Soft Shadow Optimization](#4-soft-shadow-optimization)
  - [5. Simplified IBL](#5-simplified-ibl)
  - [6. Branch Culling](#6-branch-culling)
- [Combination Suggestions in Detail](#combination-suggestions-in-detail)
  - [Lighting + Raymarching](#lighting-raymarching)
  - [Lighting + Volumetric Rendering](#lighting-volumetric-rendering)
  - [Lighting + Normal Maps / Procedural Normals](#lighting-normal-maps-procedural-normals)
  - [Lighting + Post-Processing](#lighting-post-processing)
  - [Lighting + Reflections](#lighting-reflections)
<!-- GENERATED:TOC:END -->
...
**What**: Establish the standard ShaderToy-style prototype framework �?UV coordinates, camera ray, SDF scene, normal computation.

...
- [Implementation Steps in Detail](#implementation-steps-in-detail)
  - [Step 1: Build the Base SDF Scene](#step-1-build-the-base-sdf-scene)
  - [Step 2: Compute Surface Normal](#step-2-compute-surface-normal)
  - [Step 3: Implement Classic Normal-Direction AO (Additive Accumulation)](#step-3-implement-classic-normal-direction-ao-additive-accumulation)
  - [Step 4: Apply AO to Lighting](#step-4-apply-ao-to-lighting)
  - [Step 5: Raymarching Main Loop Integration](#step-5-raymarching-main-loop-integration)
- [Variant Details](#variant-details)
  - [Variant 1: Multiplicative AO](#variant-1-multiplicative-ao)
  - [Variant 2: Multi-Scale AO](#variant-2-multi-scale-ao)
  - [Variant 3: Jittered Sampling AO](#variant-3-jittered-sampling-ao)
  - [Variant 4: Hemispherical Random Direction AO](#variant-4-hemispherical-random-direction-ao)
  - [Variant 5: Fibonacci Sphere Uniform Hemisphere AO](#variant-5-fibonacci-sphere-uniform-hemisphere-ao)
...
- [Combination Suggestions in Detail](#combination-suggestions-in-detail)
  - [1. AO + Soft Shadow](#1-ao-soft-shadow)
  - [2. AO + Sky Visibility](#2-ao-sky-visibility)
  - [3. AO + Subsurface Scattering / Bounce Light](#3-ao-subsurface-scattering-bounce-light)
  - [4. AO + Convexity / Corner Detection](#4-ao-convexity-corner-detection)
  - [5. AO + Fresnel Environment Reflection](#5-ao-fresnel-environment-reflection)
<!-- GENERATED:TOC:END -->

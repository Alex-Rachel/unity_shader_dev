...
- [Core Principles in Detail](#core-principles-in-detail)
  - [1. Escape-Time Algorithm](#1-escape-time-algorithm)
  - [2. Iterated Function System (IFS)](#2-iterated-function-system-ifs)
  - [3. Spherical Inversion Fractal](#3-spherical-inversion-fractal)
- [Implementation Steps in Detail](#implementation-steps-in-detail)
  - [Step 1: Coordinate Normalization](#step-1-coordinate-normalization)
  - [Step 2: 2D Fractal �?Mandelbrot Escape-Time Iteration](#step-2-2d-fractal-mandelbrot-escape-time-iteration)
  - [Step 3: 3D Fractal �?Distance Field Function (Mandelbulb Example)](#step-3-3d-fractal-distance-field-function-mandelbulb-example)
  - [Step 4: 3D Fractal �?IFS Distance Field (Menger Sponge Example)](#step-4-3d-fractal-ifs-distance-field-menger-sponge-example)
  - [Step 5: 3D Fractal �?Spherical Inversion Distance Field (Apollonian Type)](#step-5-3d-fractal-spherical-inversion-distance-field-apollonian-type)
  - [Step 6: Ray Marching (Sphere Tracing)](#step-6-ray-marching-sphere-tracing)
  - [Step 7: Normal Calculation (Finite Differences)](#step-7-normal-calculation-finite-differences)
  - [Step 8: Shading and Lighting](#step-8-shading-and-lighting)
  - [Step 9: Camera Setup](#step-9-camera-setup)
- [Common Variants in Detail](#common-variants-in-detail)
  - [1. 2D Mandelbrot (Distance Estimation Coloring)](#1-2d-mandelbrot-distance-estimation-coloring)
  - [2. Mandelbulb Power-N (3D Spherical Coordinate Fractal)](#2-mandelbulb-power-n-3d-spherical-coordinate-fractal)
  - [3. Menger Sponge (KIFS Folding Type)](#3-menger-sponge-kifs-folding-type)
  - [4. Quaternion Julia Set](#4-quaternion-julia-set)
  - [5. Minimal IFS Field (2D, No Ray Marching)](#5-minimal-ifs-field-2d-no-ray-marching)
...
- [Combination Suggestions](#combination-suggestions)
  - [1. Fractal + Volumetric Lighting](#1-fractal-volumetric-lighting)
  - [2. Fractal + Post-Processing (Tone Mapping / FXAA)](#2-fractal-post-processing-tone-mapping-fxaa)
  - [3. Fractal + Transparent Refraction (Multi-Bounce Refraction)](#3-fractal-transparent-refraction-multi-bounce-refraction)
  - [4. Fractal + Orbit Trap Texture Mapping](#4-fractal-orbit-trap-texture-mapping)
  - [5. Fractal + Soft Shadow](#5-fractal-soft-shadow)
<!-- GENERATED:TOC:END -->

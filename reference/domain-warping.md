...
- [Implementation Steps in Detail](#implementation-steps-in-detail)
  ...
  - [Step 3: fBM (Fractal Brownian Motion)](#step-3-fbm-fractal-brownian-motion)
  - [Step 4: Domain Warping (Core)](#step-4-domain-warping-core)
  - [Step 5: Time Animation](#step-5-time-animation)
  - [Step 6: Coloring](#step-6-coloring)
- [Common Variants in Detail](#common-variants-in-detail)
  - [Variant 1: Multi-Resolution Layered Warping](#variant-1-multi-resolution-layered-warping)
  - [Variant 2: Turbulence / Ridge Warping (Electric Arc / Plasma Effect)](#variant-2-turbulence-ridge-warping-electric-arc-plasma-effect)
  - [Variant 3: Domain Warping with Pseudo-3D Lighting](#variant-3-domain-warping-with-pseudo-3d-lighting)
  - [Variant 4: Flow Field Iterative Warping (Gas Giant Planet Effect)](#variant-4-flow-field-iterative-warping-gas-giant-planet-effect)
  - [Variant 5: 3D Volumetric Domain Warping (Explosion / Fireball Effect)](#variant-5-3d-volumetric-domain-warping-explosion-fireball-effect)
- [Performance Optimization Deep Dive](#performance-optimization-deep-dive)
  - [Bottleneck Analysis](#bottleneck-analysis)
  - [Optimization Techniques](#optimization-techniques)
- [Combination Suggestions with Complete Code Examples](#combination-suggestions-with-complete-code-examples)
  - [Combining with Ray Marching](#combining-with-ray-marching)
  - [Combining with Polar Coordinate Transform](#combining-with-polar-coordinate-transform)
  - [Combining with Cosine Color Palette](#combining-with-cosine-color-palette)
  - [Combining with Post-Processing Effects](#combining-with-post-processing-effects)
  - [Combining with Particle Systems / Geometry](#combining-with-particle-systems-geometry)
<!-- GENERATED:TOC:END -->
...
- **ShaderToy-style prototype Environment**: meaning of `iTime`, `iResolution`, `fragCoord`

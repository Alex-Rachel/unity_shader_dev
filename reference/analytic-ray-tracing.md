...
- [Use Cases (Complete List)](#use-cases-complete-list)
- [Core Principles in Detail](#core-principles-in-detail)
  - [Unified Framework](#unified-framework)
  - [Key Mathematical Formulas](#key-mathematical-formulas)
- [Implementation Steps in Detail](#implementation-steps-in-detail)
  - [Step 1: Ray Generation](#step-1-ray-generation)
  - [Step 2: Ray-Sphere Intersection](#step-2-ray-sphere-intersection)
  - [Step 3: Ray-Plane Intersection](#step-3-ray-plane-intersection)
  - [Step 4: Ray-Box Intersection (Slab Method)](#step-4-ray-box-intersection-slab-method)
  - [Step 5: Ray-Ellipsoid Intersection](#step-5-ray-ellipsoid-intersection)
  - [Step 6: Ray-Cylinder Intersection](#step-6-ray-cylinder-intersection)
  - [Step 7: Scene Intersection & Shading](#step-7-scene-intersection-shading)
  - [Step 8: Reflection & Refraction](#step-8-reflection-refraction)
- [Complete Code Template](#complete-code-template)
- [Variant Details](#variant-details)
  - [Variant 1: Path Tracing](#variant-1-path-tracing)
  - [Variant 2: Analytical Soft Shadow](#variant-2-analytical-soft-shadow)
  - [Variant 3: Analytical Antialiasing](#variant-3-analytical-antialiasing)
  - [Variant 4: Refraction (with Snell's Law)](#variant-4-refraction-with-snells-law)
  - [Variant 5: Higher-Order Algebraic Surfaces (Quartic Surfaces - Sphere4, Goursat, Torus)](#variant-5-higher-order-algebraic-surfaces-quartic-surfaces-sphere4-goursat-torus)
- [Performance Optimization Details](#performance-optimization-details)
  - [1. Distance Bound Pruning](#1-distance-bound-pruning)
  - [2. Bounding Sphere / Bounding Box Pre-Test](#2-bounding-sphere-bounding-box-pre-test)
  - [3. Shadow Ray Early Exit](#3-shadow-ray-early-exit)
  - [4. Grid Acceleration Structure](#4-grid-acceleration-structure)
  - [5. Avoiding Unnecessary sqrt](#5-avoiding-unnecessary-sqrt)
- [Combination Suggestions in Detail](#combination-suggestions-in-detail)
  - [1. Analytic Intersection + Raymarching SDF](#1-analytic-intersection-raymarching-sdf)
  - [2. Analytic Intersection + Volumetric Effects](#2-analytic-intersection-volumetric-effects)
  - [3. Analytic Intersection + PBR Material System](#3-analytic-intersection-pbr-material-system)
  - [4. Analytic Intersection + Spatial Transforms](#4-analytic-intersection-spatial-transforms)
  - [5. Analytic Intersection + Analytical AO / Soft Shadow / Antialiasing](#5-analytic-intersection-analytical-ao-soft-shadow-antialiasing)
<!-- GENERATED:TOC:END -->
...
- **ShaderToy-style prototype framework**: `mainImage()` function, `iResolution`, `iTime`, and other uniforms
...
For a complete runnable ShaderToy-style prototype template, see the "Complete Code Template" section in [SKILL.md](../SKILL.md), which includes sphere, plane, and box primitives with support for reflections and Blinn-Phong shading.
...
Key code:
```glsl
float refrIndex = 1.5; // Adjustable: index of refraction (glass�?.5, water�?.33)

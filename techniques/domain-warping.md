...
- [Common Variants](#common-variants)
  ...
  - [Variant 2: Turbulence/Ridged Warping (Electric Arc/Plasma Effect)](#variant-2-turbulenceridged-warping-electric-arcplasma-effect)
  - [Variant 3: Pseudo-3D Lit Domain Warping](#variant-3-pseudo-3d-lit-domain-warping)
  - [Variant 4: Flow Field Iterative Warping (Gas Giant Effect)](#variant-4-flow-field-iterative-warping-gas-giant-effect)
  - [Variant 5: 3D Volumetric Domain Warping (Explosion/Fireball Effect)](#variant-5-3d-volumetric-domain-warping-explosionfireball-effect)
...
```glsl
// Domain Warping �?Full Runnable Template (ShaderToy-style prototype)

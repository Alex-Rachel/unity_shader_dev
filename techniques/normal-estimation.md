...
- [Implementation Steps](#implementation-steps)
  - [Step 1: Define SDF Scene Function](#step-1-define-sdf-scene-function)
  - [Step 2: Choose Differentiation Method](#step-2-choose-differentiation-method)
  - [Step 3: Apply to Lighting](#step-3-apply-to-lighting)
- [Complete Code Template](#complete-code-template)
- [Common Variants](#common-variants)
  - [Variant 1: NuSan Reverse-Offset Forward Difference](#variant-1-nusan-reverse-offset-forward-difference)
  - [Variant 2: Adaptive Epsilon (Distance Scaling)](#variant-2-adaptive-epsilon-distance-scaling)
  - [Variant 3: Large Epsilon for Rounding / Anti-Aliasing](#variant-3-large-epsilon-for-rounding-anti-aliasing)
  - [Variant 4: Anti-Inlining Loop](#variant-4-anti-inlining-loop)
  - [Variant 5: Normal + Edge Detection](#variant-5-normal-edge-detection)
...
```glsl
// SDF Normal Estimation �?Complete ShaderToy-style prototype Template

...
- [Core Principles](#core-principles)
  ...
  - [2. Iterated Function System (IFS / KIFS)](#2-iterated-function-system-ifs-kifs)
  - [3. Spherical Inversion Fractals](#3-spherical-inversion-fractals)
- [Implementation Steps](#implementation-steps)
  - [Step 1: Coordinate Normalization](#step-1-coordinate-normalization)
  - [Step 2: 2D Mandelbrot Escape-Time Iteration](#step-2-2d-mandelbrot-escape-time-iteration)
  - [Step 3: Mandelbulb Distance Field (Spherical Coordinate Power-N)](#step-3-mandelbulb-distance-field-spherical-coordinate-power-n)
  - [Step 4: Menger Sponge Distance Field (KIFS)](#step-4-menger-sponge-distance-field-kifs)
  - [Step 5: Apollonian Distance Field (Spherical Inversion)](#step-5-apollonian-distance-field-spherical-inversion)
  - [Step 6: Ray Marching](#step-6-ray-marching)
  - [Step 7: Normal Calculation](#step-7-normal-calculation)
  - [Step 8: Shading & Lighting](#step-8-shading-lighting)
  - [Step 9: Camera](#step-9-camera)
...
- [Common Variants](#common-variants)
  ...
  - [2. Mandelbulb Power-N](#2-mandelbulb-power-n)
  - [3. Menger Sponge (KIFS)](#3-menger-sponge-kifs)
...
- Suitable for ShaderToy-style prototype, demo scene, procedural content generation
...
3D Apollonian fractal (spherical inversion type) with full ray marching pipeline, orbit trap coloring, and AO. Ready to run in ShaderToy-style prototype.

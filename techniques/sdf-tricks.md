...
- [Core Techniques](#core-techniques)
  - [Hollowing (Shell Creation)](#hollowing-shell-creation)
  - [Layered Edges (Concentric Contour Lines)](#layered-edges-concentric-contour-lines)
  - [FBM Detail on SDF (Distance-Based LOD)](#fbm-detail-on-sdf-distance-based-lod)
  - [SDF Bounding Volumes (Performance Optimization)](#sdf-bounding-volumes-performance-optimization)
  - [Binary Search Refinement](#binary-search-refinement)
  - [XOR Boolean Operation](#xor-boolean-operation)
  - [Interior SDF Structures](#interior-sdf-structures)
- [SDF Debugging Visualization](#sdf-debugging-visualization)
<!-- GENERATED:TOC:END -->

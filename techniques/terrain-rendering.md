...
- [Complete Code Template](#complete-code-template)
  - [Binary Refinement (optional, called after raymarch)](#binary-refinement-optional-called-after-raymarch)
- [Common Variants](#common-variants)
  - [Relaxation Marching](#relaxation-marching)
  - [Sign-Alternating FBM](#sign-alternating-fbm)
  - [Canyon Style (Texture-Driven + 3D Displacement)](#canyon-style-texture-driven-3d-displacement)
  - [Directional Erosion Noise](#directional-erosion-noise)
  - [Volumetric Clouds + God Rays](#volumetric-clouds-god-rays)
...
- Procedural generation of natural landscapes (mountains, canyons, dunes, etc.) in ShaderToy-style prototype / Fragment Shaders
...
- **FBM**: `f(p) = Σ (a�?× noise(2�?× R × p))`, a=0.5, R=rotation matrix, 2�?frequency doubling
- **Derivative erosion**: `f(p) = Σ (a�?× noise(p) / (1 + dot(d,d)))`, d=accumulated gradient, suppresses detail on steep slopes

...
- [Techniques](#techniques)
  - [1. Depth of Field (Thin Lens Model)](#1-depth-of-field-thin-lens-model)
  - [2. Post-Process Depth of Field (Single Pass)](#2-post-process-depth-of-field-single-pass)
  - [3. Motion Blur (Velocity-Based)](#3-motion-blur-velocity-based)
  - [4. Lens Distortion](#4-lens-distortion)
  - [5. Film Grain](#5-film-grain)
  - [6. Vignette](#6-vignette)
<!-- GENERATED:TOC:END -->

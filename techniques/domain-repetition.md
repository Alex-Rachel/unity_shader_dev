...
- [Implementation Steps](#implementation-steps)
  - [Step 1: Cartesian Domain Repetition (mod repetition)](#step-1-cartesian-domain-repetition-mod-repetition)
  - [Step 2: Symmetric Folding (abs-mod triangle wave)](#step-2-symmetric-folding-abs-mod-triangle-wave)
  - [Step 3: Angular Domain Repetition (Polar Coordinate Folding)](#step-3-angular-domain-repetition-polar-coordinate-folding)
  - [Step 4: fract Domain Folding (Fractal Iteration)](#step-4-fract-domain-folding-fractal-iteration)
  ...
  - [Step 7: Toroidal/Cylindrical Domain Warping](#step-7-toroidalcylindrical-domain-warping)
...
- [Common Variants](#common-variants)
  - [1. Volumetric Light/Glow Rendering](#1-volumetric-lightglow-rendering)
  - [2. Single-Axis/Dual-Axis Selective Repetition](#2-single-axisdual-axis-selective-repetition)
  - [3. Fractal fract Domain Folding (Apollonian Type)](#3-fractal-fract-domain-folding-apollonian-type)
  - [4. Multi-Layer Nested Repetition](#4-multi-layer-nested-repetition)
  - [5. Finite Domain Repetition (Clamp Limited)](#5-finite-domain-repetition-clamp-limited)
...
Combined demo: Cartesian repetition + angular repetition + IFS folding. Runs directly in ShaderToy-style prototype.

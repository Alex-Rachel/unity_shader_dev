...
- [Core Principles](#core-principles)
  - [Cosine Palette](#cosine-palette)
  - [HSV/HSL Branchless Conversion](#hsvhsl-branchless-conversion)
  - [CIE Lab/Lch Perceptually Uniform Interpolation](#cie-lablch-perceptually-uniform-interpolation)
  - [Blackbody Radiation Palette](#blackbody-radiation-palette)
- [Implementation](#implementation)
  - [Cosine Palette](#cosine-palette)
  - [Classic Preset Parameters](#classic-preset-parameters)
  - [HSV -> RGB (Standard + Smooth)](#hsv-rgb-standard-smooth)
  - [HSL -> RGB](#hsl-rgb)
  - [RGB -> HSV](#rgb-hsv)
  - [CIE Lab/Lch Conversion Pipeline](#cie-lablch-conversion-pipeline)
  - [sRGB Gamma & Tone Mapping](#srgb-gamma-tone-mapping)
  - [Blackbody Radiation Palette](#blackbody-radiation-palette)
- [Complete Code Template](#complete-code-template)
- [Common Variants](#common-variants)
  - [Multi-Harmonic Cosine Palette (Anti-Aliased)](#multi-harmonic-cosine-palette-anti-aliased)
  - [Hash-Driven Per-Tile Color](#hash-driven-per-tile-color)
  - [Saturation-Preserving Improved RGB Interpolation](#saturation-preserving-improved-rgb-interpolation)
  - [Circular Hue Interpolation](#circular-hue-interpolation)
  - [Additive Color Stacking (Glow/HDR)](#additive-color-stacking-glowhdr)
...
A ShaderToy-style prototype shader demonstrating all core techniques:

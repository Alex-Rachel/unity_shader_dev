...
- [Implementation Steps](#implementation-steps)
  - [Step 1: mainSound Entry Framework](#step-1-mainsound-entry-framework)
  - [Step 2: MIDI Note to Frequency](#step-2-midi-note-to-frequency)
  ...
  - [Step 9: Delay and Reverb](#step-9-delay-and-reverb)
...
- [Common Variants](#common-variants)
  - [Variant 1: Subtractive Synthesis / TB-303 Acid Synth](#variant-1-subtractive-synthesis-tb-303-acid-synth)
  ...
  - [Variant 4: Algorithmic Composition](#variant-4-algorithmic-composition)
  - [Variant 5: Circle of Fifths Chord Progressions](#variant-5-circle-of-fifths-chord-progressions)
...
## Use Cases
- Generate procedural audio using `mainSound()` in ShaderToy-style prototype
...
ShaderToy-style prototype sound shader four-layer architecture:
...
Can be pasted directly into the ShaderToy-style prototype Sound tab to run. Includes FM piano melody, kick drum rhythm, and ping-pong delay.

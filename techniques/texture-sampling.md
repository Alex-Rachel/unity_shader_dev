...
- [Implementation Steps](#implementation-steps)
  - [Step 1: Basic Sampling and UV Normalization](#step-1-basic-sampling-and-uv-normalization)
  - [Step 2: textureLod for Mipmap Control](#step-2-texturelod-for-mipmap-control)
  - [Step 3: texelFetch for Exact Pixel Reading](#step-3-texelfetch-for-exact-pixel-reading)
  - [Step 4: Manual Bilinear + Quintic Hermite Smoothing](#step-4-manual-bilinear-quintic-hermite-smoothing)
  - [Step 5: FBM Texture Noise](#step-5-fbm-texture-noise)
  - [Step 6: Separable Gaussian Blur](#step-6-separable-gaussian-blur)
  - [Step 7: Dispersion Sampling](#step-7-dispersion-sampling)
  - [Step 8: IBL Environment Sampling](#step-8-ibl-environment-sampling)
...
- [Common Variants](#common-variants)
  ...
  - [Variant 2: Buffer-as-Data Storage](#variant-2-buffer-as-data-storage)
  - [Variant 3: Dispersion Effect](#variant-3-dispersion-effect)

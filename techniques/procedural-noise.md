...
- [Core Principles](#core-principles)
  ...
  - [FBM Variant Quick Reference](#fbm-variant-quick-reference)
- [Implementation Code](#implementation-code)
  - [Hash Functions](#hash-functions)
  - [Value Noise](#value-noise)
  - [Simplex Noise](#simplex-noise)
  - [Standard FBM](#standard-fbm)
  - [Ridged FBM](#ridged-fbm)
  - [Domain Warping](#domain-warping)
  - [Fluid Noise](#fluid-noise)
  - [Derivative FBM](#derivative-fbm)
  - [Quintic Noise with Analytical Derivatives](#quintic-noise-with-analytical-derivatives)
  - [FBM with Derivatives (Erosion Terrain)](#fbm-with-derivatives-erosion-terrain)
  - [Voronoise (Voronoi-Noise Hybrid)](#voronoise-voronoi-noise-hybrid)
  - [Preventing Aliasing in Procedural Textures](#preventing-aliasing-in-procedural-textures)
- [Complete Code Template](#complete-code-template)
- [Common Variants](#common-variants)
  - [Ridged FBM](#ridged-fbm)
  - [Domain Warped FBM](#domain-warped-fbm)
  - [Derivative Erosion FBM](#derivative-erosion-fbm)
  - [Fluid Noise](#fluid-noise)
  - [Ocean Wave Octave Function](#ocean-wave-octave-function)
...
Ready to run in ShaderToy-style prototype. Switch between standard FBM / ridged FBM / domain warping modes via `#define`:

...
- [Implementation Steps](#implementation-steps)
  ...
  - [Step 3: Smooth Subtraction and Intersection (Polynomial Version)](#step-3-smooth-subtraction-and-intersection-polynomial-version)
  - [Step 4: Quadratic Optimized Version (Recommended as Default)](#step-4-quadratic-optimized-version-recommended-as-default)
  - [Step 4b: Smooth Minimum Variant Library](#step-4b-smooth-minimum-variant-library)
  - [Step 5: Basic SDF Primitives](#step-5-basic-sdf-primitives)
  - [Step 6: CSG Composition for Scene Building](#step-6-csg-composition-for-scene-building)
  - [Step 7: Smooth CSG Modeling for Organic Forms](#step-7-smooth-csg-modeling-for-organic-forms)
  - [Step 8: Ray Marching Main Loop](#step-8-ray-marching-main-loop)
  - [Step 9: Normal Calculation (Tetrahedral Sampling, 4 Samples More Efficient Than 6 with Central Differences)](#step-9-normal-calculation-tetrahedral-sampling-4-samples-more-efficient-than-6-with-central-differences)
- [Full Code Template](#full-code-template)
- [Common Variants](#common-variants)
  - [Variant 1: Exponential Smooth Union](#variant-1-exponential-smooth-union)
  - [Variant 2: Smooth Operations with Color Blending](#variant-2-smooth-operations-with-color-blending)
  - [Variant 3: Stepwise CSG Modeling (Architectural/Industrial)](#variant-3-stepwise-csg-modeling-architecturalindustrial)
  - [Variant 4: Large-Scale Organic Character Modeling](#variant-4-large-scale-organic-character-modeling)
- [Performance & Composition Tips](#performance-composition-tips)
...
```glsl
// === CSG Boolean Operations - Unity URP Full Template ===
...
// === Main Function (Unity URP Adapted) ===
out vec4 outColor;
void main() {

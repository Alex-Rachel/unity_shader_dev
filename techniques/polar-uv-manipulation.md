...
This document focuses on UV-space math that ports cleanly to URP.
- For fullscreen distortion, derive normalized screen UV in the fragment stage and feed aspect correction from _ScreenParams.
- For object-space effects, decide whether the polar conversion happens in mesh UVs, object space, world space, or view space and document that choice.
- Translate prototype variables such as fragCoord, iResolution, and iTime into URP varyings and material properties.
- Keep the transformations in HLSL, but drive animation and interaction through C# or material parameters.
...
- [Implementation Steps](#implementation-steps)
  ...
  - [Step 2: Cartesian �?Polar Coordinates](#step-2-cartesian-polar-coordinates)
  - [Step 3: Polar Space Operations](#step-3-polar-space-operations)
  - [Step 4: Polar �?Cartesian Reconstruction](#step-4-polar-cartesian-reconstruction)
  - [Step 5: Polar Coordinate Shape SDF](#step-5-polar-coordinate-shape-sdf)
...
- [Common Variants](#common-variants)
  - [Variant 1: Dynamic Vortex Background (Balatro Style)](#variant-1-dynamic-vortex-background-balatro-style)
  - [Variant 2: Polar Torus Twist (Ring Twister Style)](#variant-2-polar-torus-twist-ring-twister-style)
  - [Variant 3: Galaxy / Logarithmic Spiral (Galaxy Style)](#variant-3-galaxy-logarithmic-spiral-galaxy-style)
  - [Variant 4: Archimedean Spiral Band (Wave Greek Frieze Style)](#variant-4-archimedean-spiral-band-wave-greek-frieze-style)
  - [Variant 5: Complex / Polar Duality (Jeweled Vortex Style)](#variant-5-complex-polar-duality-jeweled-vortex-style)
...
// Paste directly into ShaderToy-style prototype to run

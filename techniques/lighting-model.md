...
- [Unity URP Executable](#unity-urp-executable)
  ...
  - [Executable Lighting Skeleton](#executable-lighting-skeleton)
  - [Validation](#validation)
- [Use Cases](#use-cases)
- [Core Principles](#core-principles)
  - [Key Formulas](#key-formulas)
- [Implementation Steps](#implementation-steps)
  - [Step 1: Scene Basics (Normal + Vector Setup)](#step-1-scene-basics-normal-vector-setup)
  - [Step 2: Lambert Diffuse](#step-2-lambert-diffuse)
  - [Step 3: Blinn-Phong Specular](#step-3-blinn-phong-specular)
  - [Step 4: Fresnel-Schlick](#step-4-fresnel-schlick)
  - [Step 5: GGX Normal Distribution (D Term)](#step-5-ggx-normal-distribution-d-term)
  - [Step 6: Geometric Shadowing (G Term)](#step-6-geometric-shadowing-g-term)
  - [Step 7: Assembling Cook-Torrance BRDF](#step-7-assembling-cook-torrance-brdf)
  - [Step 8: Multi-Light Accumulation and Compositing](#step-8-multi-light-accumulation-and-compositing)
  - [Step 9: Ambient Occlusion (AO)](#step-9-ambient-occlusion-ao)
  - [Outdoor Three-Light Model](#outdoor-three-light-model)
...
Use a forward-lit material shader. For most Unity work, lighting should integrate with URP light data rather than replacing the full lighting stack from scratch.

- Base template: `../assets/templates/urp-forward-lit.shader`
- Recipe: `../reference/recipes/mesh-surface-effect.md`
- Supporting references: `../reference/pipeline/authoring-contract.md`, `../reference/pipeline/compatibility.md`

### Minimum File Set

- `MyLit.shader`
- Optional include file only if the BRDF grows large enough to justify reuse

### Runnable Example Assets

- `../assets/examples/lighting/ForwardLitExample.shader`

### Executable Lighting Skeleton
...
- Test with `_Smoothness = 0`, `0.5`, and `1.0`.
- Toggle shadows in the scene and confirm `shadowCoord` actually affects output.
- If adding extra lights or custom BRDF terms, document whether the shader still relies on URP light loops or fully custom light accumulation.
...
- Adding material appearance to SDF scenes in ShaderToy-style prototype
...
```glsl
// Lighting Model Complete Template - Runs directly in ShaderToy-style prototype

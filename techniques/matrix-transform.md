...
- [Implementation Steps](#implementation-steps)
  - [Step 1: Screen Coordinate Normalization](#step-1-screen-coordinate-normalization)
  - [Step 2: Rotation Matrices](#step-2-rotation-matrices)
  - [Step 3: LookAt Camera](#step-3-lookat-camera)
  - [Step 4: Perspective Ray Generation](#step-4-perspective-ray-generation)
  - [Step 5: Mouse-Interactive Camera](#step-5-mouse-interactive-camera)
  - [Step 6: SDF Domain Transforms](#step-6-sdf-domain-transforms)
  - [Step 7: Quaternion Rotation](#step-7-quaternion-rotation)
- [Complete Code Template](#complete-code-template)
- [Common Variants](#common-variants)
  - [Orthographic Projection Camera](#orthographic-projection-camera)
  - [Euler Angle Full Rotation Camera](#euler-angle-full-rotation-camera)
  - [Quaternion Joint Rotation](#quaternion-joint-rotation)
  - [mat4 SRT Pipeline](#mat4-srt-pipeline)
  - [Path Camera (Animated Flight)](#path-camera-animated-flight)
...
```glsl
// mat3 camera �?focalLength controls FOV: 1.0�?0°, 2.0�?3°, 4.0�?8°
...
Can be run directly in ShaderToy-style prototype, demonstrating LookAt camera + multi-object domain transforms + mouse interaction.

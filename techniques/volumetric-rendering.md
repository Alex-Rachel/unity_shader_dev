...
- [Implementation Steps](#implementation-steps)
  ...
  - [Step 2: Volume Bounds Intersection](#step-2-volume-bounds-intersection)
...
- [Common Variants](#common-variants)
  - [Variant 1: Self-Emissive Volume (Fire/Explosions)](#variant-1-self-emissive-volume-fireexplosions)
...
- Suitable for ShaderToy-style prototype real-time fragment shaders, also portable to game engines
...
Runnable volumetric cloud renderer for ShaderToy-style prototype (iChannel0 = Gray Noise Small 256x256):

```glsl
// Volumetric Cloud Renderer �?ShaderToy-style prototype Template

...
- [Common Variants](#common-variants)
  ...
  - [Variant 3: Character/Creature Modeling](#variant-3-charactercreature-modeling)
  - [Variant 4: Symmetry Optimization](#variant-4-symmetry-optimization)
  - [Variant 5: PBR Material Rendering](#variant-5-pbr-material-rendering)
- [Performance & Composition](#performance-composition)
  - [Performance Optimization Tips](#performance-optimization-tips)
  - [Common Composition Techniques](#common-composition-techniques)
...
- Real-time rendering of 3D geometry in ShaderToy-style prototype / fragment shaders (no traditional meshes needed)
...
Runs directly in ShaderToy-style prototype. Includes multi-primitive scene, smooth blending, soft shadows, AO, and material system.
...
```glsl
// 3D SDF Full Rendering Pipeline Template - Runs in ShaderToy-style prototype

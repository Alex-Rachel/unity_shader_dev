...
- [Implementation Steps](#implementation-steps)
  ...
  - [Step 2: Atmospheric Physical Constants](#step-2-atmospheric-physical-constants)
  - [Step 3: Phase Functions](#step-3-phase-functions)
  ...
  - [Step 6: Primary Scattering Integration](#step-6-primary-scattering-integration)
  - [Step 7: Tone Mapping](#step-7-tone-mapping)
- [Complete Code Template](#complete-code-template)
- [Advanced Fog Models](#advanced-fog-models)
  - [Level 1: Basic Exponential Fog](#level-1-basic-exponential-fog)
  - [Level 2: Sun-Aware Fog (Scattering Tint)](#level-2-sun-aware-fog-scattering-tint)
  - [Level 3: Height-Based Fog (Analytical Integration)](#level-3-height-based-fog-analytical-integration)
  - [Level 4: Extinction + Inscattering Separation](#level-4-extinction-inscattering-separation)
- [Common Variants](#common-variants)
  - [Variant 1: Non-Physical Analytic Approximation (No Ray March)](#variant-1-non-physical-analytic-approximation-no-ray-march)
  - [Variant 2: Ozone Absorption Layer](#variant-2-ozone-absorption-layer)
  ...
  - [Variant 5: Analytic Fast Atmosphere (with Aerial Perspective)](#variant-5-analytic-fast-atmosphere-with-aerial-perspective)
...
Fully runnable Rayleigh + Mie atmospheric scattering for ShaderToy-style prototype:

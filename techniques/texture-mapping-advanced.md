...
- [Techniques](#techniques)
  - [1. Biplanar Mapping (Optimized Triplanar)](#1-biplanar-mapping-optimized-triplanar)
  - [2. Texture Repetition Avoidance](#2-texture-repetition-avoidance)
  - [3. Ray Differential Texture Filtering](#3-ray-differential-texture-filtering)
<!-- GENERATED:TOC:END -->

...
- [Implementation Steps](#implementation-steps)
  ...
  - [Step 2: SDF Primitive Functions](#step-2-sdf-primitive-functions)
  - [Step 3: CSG Boolean Operations](#step-3-csg-boolean-operations)
  - [Step 4: Coordinate Transforms](#step-4-coordinate-transforms)
  - [Step 5: Rendering and Anti-Aliasing](#step-5-rendering-and-anti-aliasing)
  - [Step 6: Stroke and Border](#step-6-stroke-and-border)
...
- [Common Variants](#common-variants)
  ...
  - [Variant 4: Organic Shapes (Polar SDF)](#variant-4-organic-shapes-polar-sdf)
  - [Variant 5: Bezier Curve SDF](#variant-5-bezier-curve-sdf)
- [Extended 2D SDF Library](#extended-2d-sdf-library)
- [2D SDF Modifiers](#2d-sdf-modifiers)
...
```glsl
// ===== 2D SDF Full Template (runs directly in ShaderToy-style prototype) =====

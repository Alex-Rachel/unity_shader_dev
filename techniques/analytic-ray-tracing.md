...
- [Implementation Steps](#implementation-steps)
  ...
  - [Step 6: Ray-Cylinder Intersection (With End Caps)](#step-6-ray-cylinder-intersection-with-end-caps)
  - [Step 7: Scene Intersection and Shading](#step-7-scene-intersection-and-shading)
...
- [Common Variants](#common-variants)
  ...
  - [Variant 2: Analytic Soft Shadow](#variant-2-analytic-soft-shadow)
  - [Variant 3: Analytic Anti-Aliasing](#variant-3-analytic-anti-aliasing)
  - [Variant 4: Refraction (Snell's Law)](#variant-4-refraction-snells-law)
  - [Variant 5: Higher-Order Algebraic Surface (Sphere4)](#variant-5-higher-order-algebraic-surface-sphere4)
- [Common Errors and Safeguards](#common-errors-and-safeguards)
  - [Error 1: Distance Bound Not Updated](#error-1-distance-bound-not-updated)
  - [Error 2: EPSILON Too Small Causing Self-Intersection Artifacts](#error-2-epsilon-too-small-causing-self-intersection-artifacts)
  - [Error 3: Variable Used as Loop Upper Bound](#error-3-variable-used-as-loop-upper-bound)
  - [Error 4: Division by Zero Causing NaN](#error-4-division-by-zero-causing-nan)
  - [Error 5: Missing Hash Function in Refraction Variant](#error-5-missing-hash-function-in-refraction-variant)
...
Runs directly on ShaderToy-style prototype, includes sphere, plane, and box primitives with reflection and Blinn-Phong shading.
...
```glsl
// Analytic Ray Tracing - Complete ShaderToy-style prototype Template
#define MAX_DIST 1e10
#define EPSILON 0.001
...
**Symptom**: Unity URP compilation failure or shader crash

...
- [Implementation Steps](#implementation-steps)
  - [Step 1: Hash Functions](#step-1-hash-functions)
  - [Step 2: Basic F1 Voronoi](#step-2-basic-f1-voronoi)
  - [Step 3: F1 + F2 (Edge Detection)](#step-3-f1-f2-edge-detection)
  ...
  - [Step 6: Coloring & Visualization](#step-6-coloring-visualization)
...
- [Common Variants](#common-variants)
  ...
  - [Variant 4: Crack Texture (Multi-Layer Recursive Voronoi)](#variant-4-crack-texture-multi-layer-recursive-voronoi)
...
```glsl
// === Voronoi Cellular Noise �?Complete ShaderToy-style prototype Template ===

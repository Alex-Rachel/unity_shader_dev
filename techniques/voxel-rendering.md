...
# Unity URP Full Adaptation Example
...
- [Implementation Steps](#implementation-steps)
  - [Step 1: Camera Ray Construction](#step-1-camera-ray-construction)
  - [Step 2: DDA Initialization](#step-2-dda-initialization)
  - [Step 3: DDA Traversal Loop (Branchless Version)](#step-3-dda-traversal-loop-branchless-version)
  - [Step 4: Voxel Occupancy Function](#step-4-voxel-occupancy-function)
  - [Step 5: Face Shading (Normal + Base Color)](#step-5-face-shading-normal-base-color)
  - [Step 6: Precise Hit Position and Face UV](#step-6-precise-hit-position-and-face-uv)
  - [Step 7: Neighbor Voxel AO](#step-7-neighbor-voxel-ao)
  - [Step 8: DDA Shadow Ray](#step-8-dda-shadow-ray)
- [Complete Code Template](#complete-code-template)
- [Common Variants](#common-variants)
  - [Variant 1: Glowing Voxels (Glow Accumulation)](#variant-1-glowing-voxels-glow-accumulation)
  - [Variant 2: Rounded Voxels (Intra-voxel SDF Refinement)](#variant-2-rounded-voxels-intra-voxel-sdf-refinement)
  - [Variant 3: Hybrid SDF-Voxel Traversal](#variant-3-hybrid-sdf-voxel-traversal)
  - [Variant 4: Voxel Cone Tracing](#variant-4-voxel-cone-tracing)
  - [Variant 5: PBR Lighting + Multi-Bounce Reflection](#variant-5-pbr-lighting-multi-bounce-reflection)
  - [Variant 6: Voxel Water Scene (Water + Underwater Voxels)](#variant-6-voxel-water-scene-water-underwater-voxels)
  - [Variant 7: Rotating Voxel Objects](#variant-7-rotating-voxel-objects)
  - [Variant 8: Indoor/Cave/Enclosed Scenes (Point Lights + High Ambient Lighting)](#variant-8-indoorcaveenclosed-scenes-point-lights-high-ambient-lighting)
  - [Variant 9: Voxel Character Animation](#variant-9-voxel-character-animation)
  - [Variant 10: Waterfall / Flowing Water Particle Effects](#variant-10-waterfall-flowing-water-particle-effects)
  - [Variant 11: Multi-Building / Town / Minecraft-Style Scenes (Multi-Structure Town Composition)](#variant-11-multi-building-town-minecraft-style-scenes-multi-structure-town-composition)
...
// IMPORTANT: Important: Unity URP must declare the output variable!
out vec4 fragColor;
...
- If a prototype snippet relies on GLSL-only qualifiers, translate it to URP Attributes/Varyings and a standard ShaderLab pass before integration.
...
- Real-time voxel scenes in pure fragment shader environments like ShaderToy-style prototype
...
```glsl
// === Voxel Rendering - Complete ShaderToy-style prototype Template ===
...
vec3 ambientColor = vec3(0.35, 0.3, 0.4);  // IMPORTANT: High ambient light (�?.3) to prevent silhouettes
...
2. **Enclosed/semi-enclosed scene total darkness**: caves, interiors, sci-fi bases, mazes, and other enclosed scenes cannot rely solely on directional light (completely blocked by walls/ceiling); must use point lights + high ambient light (�?.2) + emissive materials (see Variant 8)
